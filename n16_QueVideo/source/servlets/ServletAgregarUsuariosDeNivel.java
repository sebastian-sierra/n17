...
import vistas.VistaAgregarUsuariosDeNivel;
import vistas.VistaVerCaminoIntermedio;
import vistas.VistaVerUsuario;
import vistas.VistaVerVideo;

public class ServletAgregarUsuariosDeNivel extends HttpServlet
{
    ...
    private void procesarSolicitud( HttpServletRequest request, HttpServletResponse response ) throws IOException
    {
        ...
        Lista<Usuario> agregados = SistemaGestionVideos.getInstance().agregarAutomaticamenteSeguidoresDeNivel(nivel, new LlaveUsuario(emailUsuario));
        //TODO Crear Vista
        VistaAgregarUsuariosDeNivel vista = new VistaAgregarUsuariosDeNivel();
        vista.imprimirRespuesta(usuario, agregados, response);
