...
import vistas.VistaVerBusquedaUsuarios;
...
public class ServletBuscarUsuario extends HttpServlet
{
    ...
    private void procesarSolicitud( HttpServletRequest request, HttpServletResponse response ) throws IOException
    {
    	...
    	String palabraClave = request.getParameter("busquedausuario");
    	String emailUsuario = request.getParameter("usuario");
    	String criterioBus = request.getParameter("criteriodebusqueda");
    	
    	String criterioTxt = "nombre";
    	if(criterioBus.equals(SistemaGestionVideos.POR_EMAIL))
    	{
    		 criterioTxt = "e-mail";
    	}
    	...
    	Lista<Usuario> listaUsuarios = SistemaGestionVideos.getInstance().buscarUsuariosPorPalabraClave(palabraClave, criterioBus);
    	
    	VistaVerBusquedaUsuarios vista = new VistaVerBusquedaUsuarios();
    	vista.imprimirRespuesta(listaUsuarios, usuario, palabraClave, criterioTxt,response);
    }
